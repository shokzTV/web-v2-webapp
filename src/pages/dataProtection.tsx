...
export default function dataProtection(): ReactElement {
  return <PageFrame>
     <h1 className="adsimple-311160825">Datenschutzerklärung</h1>
    <h2 className="adsimple-311160825">Datenschutz</h2>
    <p>Wir haben diese Datenschutzerklärung (Fassung 10.03.2020-311160825) verfasst, um Ihnen gemäß der Vorgaben der <a className="adsimple-311160825" href="https://eur-lex.europa.eu/legal-content/DE/ALL/?uri=celex%3A32016R0679&amp;tid=311160825" target="_blank" rel="noopener">Datenschutz-Grundverordnung (EU) 2016/679</a> zu erklären, welche Informationen wir sammeln, wie wir Daten verwenden und welche Entscheidungsmöglichkeiten Sie als Besucher dieser Webseite haben.</p>
    <p>Leider liegt es in der Natur der Sache, dass diese Erklärungen sehr technisch klingen, wir haben uns bei der Erstellung jedoch bemüht die wichtigsten Dinge so einfach und klar wie möglich zu beschreiben.</p>
    <h2 className="adsimple-311160825">Rechte laut Datenschutzgrundverordnung</h2>
    <p>Ihnen stehen laut den Bestimmungen der DSGVO grundsätzlich die folgende Rechte zu:</p>
    <ul className="adsimple-311160825">
    <li className="adsimple-311160825">Recht auf Berichtigung (Artikel 16 DSGVO)</li>
    <li className="adsimple-311160825">Recht auf Löschung („Recht auf Vergessenwerden“) (Artikel 17 DSGVO)</li>
    <li className="adsimple-311160825">Recht auf Einschränkung der Verarbeitung (Artikel 18 DSGVO)</li>
    <li className="adsimple-311160825">Recht auf Benachrichtigung &#8211; Mitteilungspflicht im Zusammenhang mit der Berichtigung oder Löschung personenbezogener Daten oder der Einschränkung der Verarbeitung (Artikel 19 DSGVO)</li>
    <li className="adsimple-311160825">Recht auf Datenübertragbarkeit (Artikel 20 DSGVO)</li>
    <li className="adsimple-311160825">Widerspruchsrecht (Artikel 21 DSGVO)</li>
    <li className="adsimple-311160825">Recht, nicht einer ausschließlich auf einer automatisierten Verarbeitung — einschließlich Profiling — beruhenden Entscheidung unterworfen zu werden (Artikel 22 DSGVO)</li>
    </ul>
    <p>Wenn Sie glauben, dass die Verarbeitung Ihrer Daten gegen das Datenschutzrecht verstößt oder Ihre datenschutzrechtlichen Ansprüche sonst in einer Weise verletzt worden sind, können Sie sich an die <a className="adsimple-311160825" href="https://www.bfdi.bund.de" target="_blank" rel="noopener">Bundesbeauftragte für den Datenschutz und die Informationsfreiheit (BfDI)</a> wenden.</p>
    <h2 className="adsimple-311160825">TLS-Verschlüsselung mit https</h2>
    <p>Wir verwenden https um Daten abhörsicher im Internet zu übertragen (Datenschutz durch Technikgestaltung <a className="adsimple-311160825" href="https://eur-lex.europa.eu/legal-content/DE/TXT/HTML/?uri=CELEX:32016R0679&amp;from=DE&#038;tid=311160825" target="_blank" rel="noopener">Artikel 25 Absatz 1 DSGVO</a>). Durch den Einsatz von TLS (Transport Layer Security), einem Verschlüsselungsprotokoll zur sicheren Datenübertragung im Internet können wir den Schutz vertraulicher Daten sicherstellen. Sie erkennen die Benutzung dieser Absicherung der Datenübertragung am kleinen Schloßsymbol links oben im Browser und der Verwendung des Schemas https (anstatt http) als Teil unserer Internetadresse.</p>
    <h2 className="adsimple-311160825">Google Fonts Datenschutzerklärung</h2>
    ...
    <h3 className="adsimple-311160825">Was sind Google Fonts?</h3>
    <p>Google Fonts (früher Google Web Fonts) ist ein interaktives Verzeichnis mit mehr als 800 Schriftarten, die die <a className="adsimple-311160825" href="https://de.wikipedia.org/wiki/Google_LLC?tid=311160825" target="_blank" rel="noopener">Google LLC</a> zur freien Verwendung bereitstellt.</p>
    ...
    <h3 className="adsimple-311160825">Warum verwenden wir Google Fonts auf unserer Webseite?</h3>
    ...
    <h3 className="adsimple-311160825">Welche Daten werden von Google gespeichert?</h3>
    ...
    <h3 className="adsimple-311160825">Wie lange und wo werden die Daten gespeichert?</h3>
    ...
    <h3 className="adsimple-311160825">Wie kann ich meine Daten löschen bzw. die Datenspeicherung verhindern?</h3>
    <p>Jene Daten, die Google für einen Tag bzw. ein Jahr speichert können nicht einfach gelöscht werden. Die Daten werden beim Seitenaufruf automatisch an Google übermittelt. Um diese Daten vorzeitig löschen zu können, müssen Sie den Google-Support auf <a className="adsimple-311160825" href="https://support.google.com/?hl=de&amp;tid=311160825" target="_blank" rel="noopener">https://support.google.com/?hl=de&amp;tid=311160825</a> kontaktieren. Datenspeicherung verhindern Sie in diesem Fall nur, wenn Sie unsere Seite nicht besuchen.</p>
    <p>Anders als andere Web-Schriften erlaubt uns Google uneingeschränkten Zugriff auf alle Schriftarten. Wir können also unlimitiert auf ein Meer an Schriftarten zugreifen und so das Optimum für unsere Webseite rausholen. Mehr zu Google Fonts und weiteren Fragen finden Sie auf <a className="adsimple-311160825" href="https://developers.google.com/fonts/faq?tid=311160825" target="_blank" rel="noopener">https://developers.google.com/fonts/faq?tid=311160825</a>. Dort geht zwar Google auf datenschutzrelevante Angelegenheiten ein, doch wirklich detaillierte Informationen über Datenspeicherung sind nicht enthalten. Es ist relativ schwierig (beinahe unmöglich), von Google wirklich präzise Informationen über gespeicherten Daten zu bekommen.</p>
    <p>Welche Daten grundsätzlich von Google erfasst werden und wofür diese Daten verwendet werden, können Sie auch auf <a className="adsimple-311160825" href="https://policies.google.com/privacy?hl=de&amp;tid=311160825" target="_blank" rel="noopener">https://www.google.com/intl/de/policies/privacy/</a> nachlesen.</p>
    <h2 className="adsimple-311160825">Google Fonts Lokal Datenschutzerklärung</h2>
    ...
    <h3 className="adsimple-311160825">Was sind Google Fonts?</h3>
    <p>Google Fonts (früher Google Web Fonts) ist ein interaktives Verzeichnis mit mehr als 800 Schriftarten, die die <a className="adsimple-311160825" href="https://de.wikipedia.org/wiki/Google_LLC?tid=311160825">Google LLC</a> zur freien Verwendung bereitstellt. Mit Google Fonts könnte man die Schriften nutzen, ohne sie auf den eigenen Server hochzuladen. Doch um diesbezüglich jede Informationsübertragung zum Google-Server zu unterbinden, haben wir die Schriftarten auf unseren Server heruntergeladen. Auf diese Weise handeln wir datenschutzkonform und senden keine Daten an Google Fonts weiter.</p>
    <p>Anders als andere Web-Schriften erlaubt uns Google uneingeschränkten Zugriff auf alle Schriftarten. Wir können also unlimitiert auf ein Meer an Schriftarten zugreifen und so das Optimum für unsere Webseite rausholen. Mehr zu Google Fonts und weiteren Fragen finden Sie auf <a className="adsimple-311160825" href="https://developers.google.com/fonts/faq?tid=311160825">https://developers.google.com/fonts/faq?tid=311160825</a>.</p>
    <h2 className="adsimple-311160825">Automatische Datenspeicherung</h2>
    <p>Wenn Sie heutzutage Webseiten besuchen, werden gewisse Informationen automatisch erstellt und gespeichert, so auch auf dieser Webseite.</p>
    <p>Wenn Sie unsere Webseite so wie jetzt gerade besuchen, speichert unser Webserver (Computer auf dem diese Webseite gespeichert ist) automatisch Daten wie</p>
    <ul className="adsimple-311160825">
    <li className="adsimple-311160825">die Adresse (URL) der aufgerufenen Webseite</li>
    <li className="adsimple-311160825">Browser und Browserversion</li>
    <li className="adsimple-311160825">das verwendete Betriebssystem</li>
    <li className="adsimple-311160825">die Adresse (URL) der zuvor besuchten Seite (Referrer URL)</li>
    <li className="adsimple-311160825">den Hostname und die IP-Adresse des Geräts von welchem aus zugegriffen wird</li>
    <li className="adsimple-311160825">Datum und Uhrzeit</li>
    </ul>
    ...
    <h3 className="adsimple-311160825">Cookies von Cloudflare</h3>
    <ul className="adsimple-311160825">
    <li className="adsimple-311160825">__cfduid
    <ul className="adsimple-311160825">
    <li className="adsimple-311160825">Ablaufzeit: 1 Jahr</li>
    <li className="adsimple-311160825">Verwendung: Sicherheitseinstellungen für jeden einzelnen Besucher</li>
    <li className="adsimple-311160825">Beispielhafter Wert: d798bf7df9c1ad5b7583eda5cc5e78311160825</li>
    </ul>
    </li>
    </ul>
    ...
    <p>Cloudflare ist aktiver Teilnehmer beim EU-U.S. Privacy Shield Framework wodurch der korrekte und sichere Datentransfer persönlicher Daten geregelt wird. Mehr Informationen dazu finden Sie auf <a className="adsimple-311160825" href="https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0&amp;tid=311160825" target="_blank" rel="noopener">https://www.privacyshield.gov/participant?id=a2zt0000000GnZKAA0</a>.<br />
    Mehr Informationen zum Datenschutz bei Cloudflare finden Sie auf <a className="adsimple-311160825" href="https://www.cloudflare.com/de-de/privacypolicy/?tid=311160825" target="_blank" rel="noopener">https://www.cloudflare.com/de-de/privacypolicy/</a>
    </p>
    <h2 className="adsimple-311160825">YouTube Datenschutzerklärung</h2>
    ...
    <h3 className="adsimple-311160825">Was ist YouTube?</h3>
    ...
    <h3 className="adsimple-311160825">Warum verwenden wir YouTube-Videos auf unserer Webseite?</h3>
    ...
    <h3 className="adsimple-311160825">Welche Daten werden von YouTube gespeichert?</h3>
    ...
    <p>
    <strong className="adsimple-311160825">Name:</strong> YSC<br />
    <strong className="adsimple-311160825">Wert:</strong> b9-CV6ojI5Y<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie registriert eine eindeutige ID, um Statistiken des gesehenen Videos zu speichern.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach Sitzungsende</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> PREF<br />
    <strong className="adsimple-311160825">Wert:</strong> f1=50000000<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie registriert ebenfalls Ihre eindeutige ID. Google bekommt über PREF Statistiken, wie Sie YouTube-Videos auf unserer Webseite verwenden.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 8 Monate</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> GPS<br />
    <strong className="adsimple-311160825">Wert:</strong> 1<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie registriert Ihre eindeutige ID auf mobilen Geräten, um den GPS-Standort zu tracken.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 30 Minuten</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> VISITOR_INFO1_LIVE<br />
    <strong className="adsimple-311160825">Wert:</strong> 95Chz8bagyU<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie versucht die Bandbreite des Users auf unseren Webseiten (mit eingebautem YouTube-Video) zu schätzen.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 8 Monaten</p>
    <p>Weitere Cookies, die gesetzt werden, wenn Sie mit Ihrem YouTube-Konto angemeldet sind:</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> APISID<br />
    <strong className="adsimple-311160825">Wert:</strong> zILlvClZSkqGsSwI/AU1aZI6HY7311160825-<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie wird verwendet, um ein Profil über Ihre Interessen zu erstellen. Genützt werden die Daten für personalisierte Werbeanzeigen.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 2 Jahre</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> CONSENT<br />
    <strong className="adsimple-311160825">Wert:</strong> YES+AT.de+20150628-20-0<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Das Cookie speichert den Status der Zustimmung eines Users zur Nutzung unterschiedlicher Services von Google. CONSENT dient auch der Sicherheit, um User zu überprüfen und Userdaten vor unbefugten Angriffen zu schützen.<br />
    <strong className="adsimple-311160825">Ablaufdatum: </strong>nach 19 Jahren</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> HSID<br />
    <strong className="adsimple-311160825">Wert:</strong> AcRwpgUik9Dveht0I<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie wird verwendet, um ein Profil über Ihre Interessen zu erstellen. Diese Daten helfen personalisierte Werbung anzeigen zu können.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 2 Jahren</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> LOGIN_INFO<br />
    <strong className="adsimple-311160825">Wert:</strong> AFmmF2swRQIhALl6aL…<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> In diesem Cookie werden Informationen über Ihre Login-Daten gespeichert.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 2 Jahren</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> SAPISID<br />
    <strong className="adsimple-311160825">Wert:</strong> 7oaPxoG-pZsJuuF5/AnUdDUIsJ9iJz2vdM<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie funktioniert, indem es Ihren Browser und Ihr Gerät eindeutig identifiziert. Es wird verwendet, um ein Profil über Ihre Interessen zu erstellen.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 2 Jahren</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> SID<br />
    <strong className="adsimple-311160825">Wert:</strong> oQfNKjAsI311160825-<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie speichert Ihre Google-Konto-ID und Ihren letzten Anmeldezeitpunkt in digital signierter und verschlüsselter Form.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 2 Jahren</p>
    <p>
    <strong className="adsimple-311160825">Name:</strong> SIDCC<br />
    <strong className="adsimple-311160825">Wert:</strong> AN0-TYuqub2JOcDTyL<br />
    <strong className="adsimple-311160825">Verwendungszweck:</strong> Dieses Cookie speichert Informationen, wie Sie die Webseite nutzen und welche Werbung Sie vor dem Besuch auf unserer Seite möglicherweise gesehen haben.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 3 Monaten</p>
    <h3 className="adsimple-311160825">Wie lange und wo werden die Daten gespeichert?</h3>
    <p>Die Daten, die YouTube von Ihnen erhält und verarbeitet werden auf den Google-Servern gespeichert. Die meisten dieser Server befinden sich in Amerika. Unter <a className="adsimple-311160825" href="https://www.google.com/about/datacenters/inside/locations/?hl=de" target="_blank" rel="noopener">https://www.google.com/about/datacenters/inside/locations/?hl=de</a>  sehen Sie genau wo sich die Google-Rechenzentren befinden. Ihre Daten sind auf den Servern verteilt. So sind die Daten schneller abrufbar und vor Manipulation besser geschützt.</p>
    ...
    <p>
    <a className="adsimple-311160825" href="https://support.google.com/chrome/answer/95647?tid=311160825" target="_blank" rel="noopener">Chrome: Cookies in Chrome löschen, aktivieren und verwalten</a>
    </p>
    <p>
    <a className="adsimple-311160825" href="https://support.apple.com/de-at/guide/safari/sfri11471/mac?tid=311160825" target="_blank" rel="noopener">Safari: Verwalten von Cookies und Websitedaten mit Safari</a>
    </p>
    <p>
    <a className="adsimple-311160825" href="https://support.mozilla.org/de/kb/cookies-und-website-daten-in-firefox-loschen?tid=311160825" target="_blank" rel="noopener">Firefox: Cookies löschen, um Daten zu entfernen, die Websites auf Ihrem Computer abgelegt haben</a>
    </p>
    <p>
    <a className="adsimple-311160825" href="https://support.microsoft.com/de-at/help/17442/windows-internet-explorer-delete-manage-cookies?tid=311160825" target="_blank" rel="noopener">Internet Explorer: Löschen und Verwalten von Cookies</a>
    </p>
    <p>
    <a className="adsimple-311160825" href="https://support.microsoft.com/de-at/help/4027947/windows-delete-cookies?tid=311160825" target="_blank" rel="noopener">Microsoft Edge: Löschen und Verwalten von Cookies</a>
    </p>
    <p>Falls Sie grundsätzlich keine Cookies haben wollen, können Sie Ihren Browser so einrichten, dass er Sie immer informiert, wenn ein Cookie gesetzt werden soll. So können Sie bei jedem einzelnen Cookie entscheiden, ob Sie es erlauben oder nicht. Da YouTube ein Tochterunternehmen von Google ist, gibt es eine gemeinsame Datenschutzerklärung. Wenn Sie mehr über den Umgang mit Ihren Daten erfahren wollen, empfehlen wir Ihnen die Datenschutzerklärung unter <a className="adsimple-311160825" href="https://policies.google.com/privacy?hl=de" target="_blank" rel="noopener">https://policies.google.com/privacy?hl=de.</a>
    </p>
    <h2 className="adsimple-311160825">Twitter Datenschutzerklärung</h2>
    ...
    <h3 className="adsimple-311160825">Was ist Twitter?</h3>
    ...
    <h3 className="adsimple-311160825">Warum verwenden wir Twitter auf unserer Webseite?</h3>
    ...
    <h3 className="adsimple-311160825">Welche Daten werden von Twitter gespeichert?</h3>
    ...
    <p>
    <strong className="adsimple-311160825">Name:</strong> personalization_id<br />
    <strong className="adsimple-311160825">Wert:</strong> &#8220;v1_cSJIsogU51SeE311160825&#8221;<br />
    <strong className="adsimple-311160825">Verwendungszweck: </strong>Dieses Cookie speichert Informationen, wie Sie die Webseite nutzen und über welche Werbung Sie möglicherweise zu Twitter gekommen sind.<br />
    <strong className="adsimple-311160825">Ablaufdatum:</strong> nach 2 Jahre</p>
    <p>
    <strong className="adsimple-311160825">Name: </strong>lang<br />
    <strong className="adsimple-311160825">Wert: </strong>de<br />
    <strong className="adsimple-311160825">Verwendungszweck: </strong>Dieses Cookie speichert Ihre voreingestellte bzw. bevorzugte Sprache.<br />
    <strong className="adsimple-311160825">Ablaufdatum: </strong>nach Sitzungsende</p>
    <p>
    <strong className="adsimple-311160825">Name: </strong>guest_id<br />
    <strong className="adsimple-311160825">Wert: </strong>311160825v1%3A157132626<br />
    <strong className="adsimple-311160825">Verwendungszweck: </strong>Dieses Cookie wird gesetzt, um Sie als Gast zu identifizieren.<strong className="adsimple-311160825"> </strong>
    <br />
    <strong className="adsimple-311160825">Ablaufdatum: </strong>nach 2 Jahren</p>
    <p>
    <strong className="adsimple-311160825">Name: </strong>fm<br />
    <strong className="adsimple-311160825">Wert: </strong>0<br />
    <strong className="adsimple-311160825">Verwendungszweck: </strong>Zu diesem Cookie konnten wir leider den Verwendungszweck nicht in Erfahrung bringen.<br />
    <strong className="adsimple-311160825">Ablaufdatum: </strong>nach Sitzungsende</p>
    <p>
    <strong className="adsimple-311160825">Name: </strong>external_referer<br />
    <strong className="adsimple-311160825">Wert: </strong>3111608252beTA0sf5lkMrlGt<br />
    <strong className="adsimple-311160825">Verwendungszweck: </strong>Dieses Cookie sammelt anonyme Daten, wie zum Beispiel wie oft Sie Twitter besuchen und wie lange Sie Twitter besuchen.<br />
    <strong className="adsimple-311160825">Ablaufdatum: </strong>Nach 6 Tage</p>
    <p>
    <strong className="adsimple-311160825">Name: </strong>eu_cn<br />
    <strong className="adsimple-311160825">Wert: </strong>1<br />
    <strong className="adsimple-311160825">Verwendungszweck: </strong>Dieses Cookie speichert Useraktivität und dient diversen Werbezwecken von Twitter. <strong className="adsimple-311160825">
    <br />
    Ablaufdatum: </strong>Nach einem Jahr</p>
    <p>
    <strong className="adsimple-311160825">Name: </strong>ct0<br />
    <strong className="adsimple-311160825">Wert: </strong>c1179f07163a365d2ed7aad84c99d966<br />
    <strong className="adsimple-311160825">Verwendungszweck: </strong>Zu diesem Cookie haben wir leider keine Informationen gefunden.<br />
    <strong className="adsimple-311160825">Ablaufdatum: </strong>nach 6 Stunden</p>
    <p>
    <strong className="adsimple-311160825">Name: </strong>_twitter_sess<br />
    <strong className="adsimple-311160825">Wert: </strong>53D%253D&#8211;dd0248311160825-<br />
    <strong className="adsimple-311160825">Verwendungszweck: </strong>Mit diesem Cookie können Sie Funktionen innerhalb der Twitter-Webseite nutzen.<br />
    <strong className="adsimple-311160825">Ablaufdatum: </strong>nach Sitzungsende</p>
    <p>
    <strong className="adsimple-311160825">Anmerkung:</strong> Twitter arbeitet auch mit Drittanbietern zusammen. Darum haben wir bei unsrem Test auch die drei Google-Analytics-Cookies _ga, _gat, _gid erkannt.</p>
    ...
    <p>Wenn Sie kein Twitter-Konto besitzen, können Sie auf <a className="adsimple-311160825" href="https://twitter.com/">twitter.com</a> gehen und dann auf „Individualisierung“ klicken. Unter dem Punkt „Individualisierung und Daten“ können Sie Ihre erhobenen Daten verwalten.</p>
    ...
    <p>Twitter verwendet die Daten auch für personalisierte Werbung in- und außerhalb von Twitter. In den Einstellungen können Sie unter „Individualisierung und Daten“ die personalisierte Werbung abschalten. Wenn Sie Twitter auf einem Browser nutzen, können Sie die personalisierte Werbung unter <a className="adsimple-311160825" href="http://optout.aboutads.info/?c=2&amp;lang=EN" target="_blank" rel="follow noopener">http://optout.aboutads.info/?c=2&amp;lang=EN</a> deaktivieren.</p>
    <p>Twitter ist aktiver Teilnehmer beim EU-U.S. Privacy Shield Framework. Dieses Framework stellt eine korrekte Datenübertragung zwischen den USA und der Europäischen Union sicher. Unter <a className="adsimple-311160825" href="https://www.privacyshield.gov/participant?id=a2zt0000000TORzAAO" target="_blank" rel="noopener">https://www.privacyshield.gov/participant?id=a2zt0000000TORzAAO</a> erfahren Sie mehr darüber.</p>
    <p>Wir hoffen, wir haben Ihnen einen grundsätzlichen Überblick über die Datenverarbeitung durch Twitter gegeben. Wir erhalten keinen Daten von Twitter und tragen auch keine Verantwortung darüber, was Twitter mit Ihren Daten macht. Falls Sie noch weitere Fragen zu diesem Thema haben, empfehlen wir Ihnen die Twitter-Datenschutzerklärung unter <a className="adsimple-311160825" href="https://twitter.com/de/privacy">https://twitter.com/de/privacy</a>.</p>
    <p style={{marginTop: '15px'}}>Quelle: Erstellt mit dem <a title="Datenschutz Generator Deutschland" href="https://www.adsimple.de/datenschutz-generator/" target="_blank" rel="noopener">Datenschutz Generator</a> von AdSimple in Kooperation mit <a href="https://www.slashtechnik.de" target="_blank" rel="noopener" title="">slashtechnik.de</a>
    </p>
