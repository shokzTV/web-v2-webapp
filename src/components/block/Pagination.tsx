...
export default function Pagination({total, page, setPage, noTopSpacing = false}: Props): ReactElement | null {
    ...
    if(total > 1) {
        return <div className={classNames('paginationWrapper', {noTopSpacing})}>
