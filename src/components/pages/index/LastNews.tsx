...
export default function LastNews(): ReactElement {
    const [news, setNews] = useState<News[]>(Array(15).fill(undefined));

    useEffect(() => {
        const loadNews = async () => setNews(await fetchRecentNews());
        loadNews();
    }, []);
